...
export default function AdminNotification({isShow, setIsShow, msg}) {
    return (
        <>
            {isShow && (
                <div className="flex items-center justify-center px-4 lg:px-0 py-12">
                    <div id="alert" className={isShow ? "transition duration-150 ease-in-out lg:w-11/12 mx-auto py-3 px-4 bg-white md:flex items-center justify-between shadow rounded" : "transition duration-150 ease-in-out lg:w-11/12 mx-auto py-3 px-4  bg-white md:flex items-center justify-between shadow rounded translate-hide"}>
                        <div className="sm:flex sm:items-start lg:items-center">
                            ...
                            <div className="h-1 w-1 bg-gray-300 rounded-full mr-2 hidden xl:block" />
                            <p className="text-sm sm:text-base text-gray-600 pt-2 sm:pt-0 pb-2 sm:pb-0">
                                {msg}
                            </p>
                        </div>
                        <div className="flex items-center justify-end sm:mt-4 md:mt-0 ml-4">
                            <div onClick={() => setIsShow(false)} className="cursor-pointer text-gray-400">
